      ...
      <div className="projects">
        ...
        <Container>
          ...
          <Row className="pt-3 pb-5 align-items-center">
            ...
            <Col xs={12} md={6}>
              <Row className="project-detail-1 align-items-start  p-2 rounded">
                ...
                <br />
                Official website for OUTECH, CNC machine company in South Korea
              </Row>
          ...
          <Row className="pt-3 pb-5 align-items-center">
            ...
            <Col xs={12} md={6}>
              <Row className="project-detail-1 align-items-start  p-2 rounded">
                <strong className="example-title">Homedeco Landing Page</strong>
          ...
          <Row className="pt-3 pb-5 align-items-center">
            ...
            <Col xs={12} md={6}>
              <Row className="project-detail-1 align-items-start  p-2 rounded">
                ...
                <br />A user-space device driver for a remotely connected cloud
                storage device built in systems programming course
              </Row>
            ...
            <Col xs={12} md={6}>
              ...
              <Row className="project-detail-2 pt-3 pb-5 align-items-center ">
                <ul>
                  ...
                  <li>Popular movie DB management with CRUD functionalities</li>
                </ul>
              </Row>
          ...
          <Row className="pt-3 pb-5 align-items-center">
            ...
            <Col xs={12} md={6}>
              <Row className="project-detail-1 align-items-start  p-2 rounded">
                ...
                <br />A web chat application running on firebase made for React
                practice
              </Row>
